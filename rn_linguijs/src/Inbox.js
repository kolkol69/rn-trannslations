...
export default class App extends React.Component {
      ...
      >
        <SafeAreaView style={styles.container}>
          <Button
            ...
            title={i18n.t`toggle language to ${
              activeLanguage === "en" ? "cs" : "en"
            }`}
          />
          <Inbox
            username="John"
  ...
  showAlert = () => {
    ...
    Alert.alert("", i18n.t`Do you want to mark all your messages as read?`, [
      {
        text: "OK",
        onPress: () => {
          this.setState({
...
const Inbox = withI18n()(
  ({ messages, markAsRead, username, addMessage, i18n }) => {
    ...
    return (
      <View style={styles.container}>
        <View style={styles.container2}>
          ...
          <Button
            onPress={addMessage}
            title={i18n.t`increment number (cs is better for that)`}
          />
          <Plural
            value={messagesCount}
